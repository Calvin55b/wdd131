...
document.querySelector("#enrollStudent").addEventListener("click", function () {
  ...
  document.querySelector('#courseName').testContent = aCourse.name;
  document.querySelector('#courseCode').testContent = aCourse.code;
 document.querySelector('img').setAttribute('src',aCourse.logo)
 document.querySelector('img').setAttribute('alt', 'Js Logo')
//This is to get sis A's room number//
